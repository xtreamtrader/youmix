...
export class CreateProject1602341516991 implements MigrationInterface {
    name = 'CreateProject1602341516991'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "project_member" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "role" character varying NOT NULL, "username" character varying NOT NULL, "project_id" uuid NOT NULL, CONSTRAINT "PK_c844ca053f932f538be195aa4df" PRIMARY KEY ("username", "project_id"))`);
